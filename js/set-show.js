...
function cluster() {
    ...
    $.get(API_SERVER + "model/" + $("#select_data_set").val() + "/set/kmeans/?header=" + header.join(",") + "&metric=" + $("#select_metric").val() + "&n_clusters=" + $("#input_clusters").val() + "&set_id=" + $("#input_set_id").val(), function (data) {
