...
var FEATURE_TAGS = [[
    ...
    {id: "id", text: "ID", hint: "Customer ID", show_in_pred_table: false, show_in_detail_table: false},
    {id: "segment", text: "Segment", hint: "Customer Segment", show_in_pred_table: false, show_in_detail_table: false},
    {id: "age", text: "Age", hint: "Customer Age", show_in_pred_table: false, show_in_detail_table: true},
    {id: "gender", text: "Gender", hint: "Customer Gender", show_in_pred_table: true, show_in_detail_table: false},
    {id: "yrs_w_club", text: "Club Years", hint: "Years with the Club", show_in_pred_table: true, show_in_detail_table: true},
    {id: "is_member", text: "Member", hint: "Whether the Customer Is a Member", show_in_pred_table: true, show_in_detail_table: false},
    {id: "is_hrs_owner", text: "Horse Owner", hint: "Whether the Customer Is a Horse Owner", show_in_pred_table: true, show_in_detail_table: false},
    {id: "major_channel", text: "Major Channel", hint: "Major Racing Betting Channel", show_in_pred_table: true, show_in_detail_table: true},
    {id: "mtg_num", text: "Active Meetings", hint: "# of Active Meetings in Recent 83 Meetings", show_in_pred_table: true, show_in_detail_table: true},
    {id: "inv", text: "Turnover", hint: "Total Turnover of Recent 83 Meetings", show_in_pred_table: true, show_in_detail_table: true},
    {id: "div", text: "Dividend", hint: "Total Dividend of Recent 83 Meetings", show_in_pred_table: true, show_in_detail_table: true},
    {id: "rr", text: "Recovery Rate", hint: "Divide Dividend by Turnover", show_in_pred_table: true, show_in_detail_table: true},
    {id: "active_rate_previous_83", text: "Active Rate (Prev. 83)", hint: "Active Rate of Previous 83 Meetings", show_in_pred_table: true, show_in_detail_table: true},
