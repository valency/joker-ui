...
<head>
    ...
    echo "<title>SmartCube | " . $sub_words[1][9] . "</title>";
    ?>
...
<div class="page-container">
    <?php echo curl($PROTOCOL . $DOMAIN . '/joker/components/sidebar.php?menu=1&sub=9'); ?>
    <!-- BEGIN CONTENT -->
    <div class="page-content-wrapper">
        <div class="page-content">
            <?php echo curl($PROTOCOL . $DOMAIN . '/joker/components/breadcrumb.php?menu=1&sub=9'); ?>
            <!-- BEGIN PAGE -->
...
<script src="js/feature-4-stat.js" type="text/javascript"></script>
